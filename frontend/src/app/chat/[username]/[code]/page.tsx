...
const defaultTheme: ChatTheme = {
  ...
  sticky_host_message: "w-full rounded-xl px-3 py-2 pr-[calc(2.5%+5rem-5px)] bg-blue-600 font-medium transition-all duration-300",
  ...
  sticky_pinned_message: "w-full rounded-xl px-3 py-2 pr-[calc(2.5%+5rem-5px)] bg-purple-600 shadow-md",
