      ...
      <main className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-12 max-w-2xl mx-auto">
            Create an instant group chat for your community and engage your audience with ChatPop
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-md">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Public & Private Rooms</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Control who can join your chat with access codes for private rooms
              </p>
            </div>
            ...
            <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-md">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Exclusive Access</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Offer exclusive back rooms, pinned chats, and receive tips for engagement
              </p>
            </div>
            ...
            <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-md">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Real-time Engagement</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Voice, video, and photo sharing to keep your audience engaged
              </p>
            </div>
          </div>
        </div>
