...
from photo_analysis.utils.rate_limit import (
    get_rate_limit_key,
    check_rate_limit,
...
class RateLimitingTests(TestCase):
    ...
    def test_rate_limit_key_prioritizes_user_id(self):
        ...
        self.assertEqual(key, 'photo_analysis:rate_limit:user:123')
    ...
    def test_rate_limit_key_falls_back_to_fingerprint(self):
        ...
        self.assertEqual(key, 'photo_analysis:rate_limit:fp:test-fp-456')
    ...
    def test_rate_limit_key_falls_back_to_ip(self):
        ...
        self.assertEqual(key, 'photo_analysis:rate_limit:ip:10.0.0.1')
        self.assertNotIn('user:', key)
        self.assertNotIn('fp:', key)
