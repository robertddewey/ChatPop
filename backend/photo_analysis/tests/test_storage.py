...
class MediaStorageTests(TestCase):
    ...
    def test_save_file_to_local_storage(self, mock_storage):
        ...
        # Configure mock
        mock_storage.save.return_value = 'photo_analysis/test.png'
        ...
        # Verify
        self.assertEqual(storage_path, 'photo_analysis/test.png')
        ...
        self.assertEqual(call_args[0][0], 'photo_analysis/test.png')
    ...
    def test_save_file_generates_unique_filename_when_not_provided(self, mock_storage):
        ...
        # Configure mock
        mock_storage.save.return_value = 'photo_analysis/generated.png'
        ...
        # Verify
        self.assertTrue(storage_path.startswith('photo_analysis/'))
    ...
    def test_delete_file_successfully(self, mock_storage):
        ...
        # Delete file
        result = MediaStorage.delete_file('photo_analysis/test.png')

        # Verify
        self.assertTrue(result)
        mock_storage.exists.assert_called_once_with('photo_analysis/test.png')
        mock_storage.delete.assert_called_once_with('photo_analysis/test.png')
    ...
    def test_delete_file_returns_false_when_file_not_exists(self, mock_storage):
        ...
        # Delete file
        result = MediaStorage.delete_file('photo_analysis/nonexistent.png')

        # Verify
        self.assertFalse(result)
        mock_storage.exists.assert_called_once_with('photo_analysis/nonexistent.png')
    ...
    def test_get_file_url_returns_correct_proxy_path(self):
        ...
        url = MediaStorage.get_file_url('photo_analysis/test.png')

        self.assertEqual(url, '/api/chats/media/photo_analysis/test.png')
    ...
    def test_get_file_returns_file_when_exists(self, mock_storage):
        ...
        # Get file
        result = MediaStorage.get_file('photo_analysis/test.png')

        # Verify
        self.assertIsNotNone(result)
        self.assertEqual(result, mock_file)
        mock_storage.exists.assert_called_once_with('photo_analysis/test.png')
        mock_storage.open.assert_called_once_with('photo_analysis/test.png', 'rb')
    ...
    def test_get_file_returns_none_when_not_exists(self, mock_storage):
        ...
        # Get file
        result = MediaStorage.get_file('photo_analysis/nonexistent.png')
    ...
    def test_file_exists_returns_true_when_exists(self, mock_storage):
        ...
        # Check existence
        result = MediaStorage.file_exists('photo_analysis/test.png')
    ...
    def test_file_exists_returns_false_when_not_exists(self, mock_storage):
        ...
        # Check existence
        result = MediaStorage.file_exists('photo_analysis/nonexistent.png')
    ...
    def test_save_file_preserves_directory_structure(self, mock_storage):
        ...
        # Configure mock
        mock_storage.save.return_value = 'photo_analysis/subfolder/test.png'

        # Save file with nested directory
        storage_path, storage_type = MediaStorage.save_file(
            file_obj=self.test_image_file,
            directory='photo_analysis/subfolder',
            filename='test.png'
        )

        # Verify path structure
        self.assertEqual(storage_path, 'photo_analysis/subfolder/test.png')
        self.assertIn('photo_analysis/subfolder', storage_path)
