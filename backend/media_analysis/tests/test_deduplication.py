...
from media_analysis.utils.fingerprinting.image_hash import calculate_phash
...
class DeduplicationTests(TestCase):
    ...
    @patch('media_analysis.views.get_vision_provider')
    ...
    def test_duplicate_image_returns_cached_analysis(self, mock_save_file, mock_get_vision_provider):
        ...
        mock_save_file.return_value = ('media_analysis/test.jpg', 'local')

        # Mock vision provider response
        from media_analysis.utils.vision.base import AnalysisResult, ChatSuggestion
    ...
    def test_duplicate_increments_times_used_counter(self):
        ...
        analysis = PhotoAnalysis.objects.create(
            ...
            image_path='media_analysis/test.jpg',
            storage_type='local',
