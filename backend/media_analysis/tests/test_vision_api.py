...
from media_analysis.utils.vision.base import AnalysisResult, ChatSuggestion, VisionProvider
from media_analysis.utils.vision.openai_vision import OpenAIVisionProvider, get_vision_provider
...
class OpenAIVisionAPITests(TestCase):
    ...
    @patch('media_analysis.utils.vision.openai_vision.OpenAI')
    ...
    @patch('media_analysis.utils.vision.openai_vision.settings')
