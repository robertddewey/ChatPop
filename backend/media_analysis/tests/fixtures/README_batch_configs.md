...
**Usage:**
```bash
./venv/bin/python manage.py batch_photo_upload media_analysis/tests/fixtures/all_photos.json
```
...
**Usage:**
```bash
./venv/bin/python manage.py batch_photo_upload media_analysis/tests/fixtures/bourbon_vs_beer.json --no-cache
```
...
**Usage:**
```bash
./venv/bin/python manage.py batch_photo_upload media_analysis/tests/fixtures/movie_posters.json --no-cache
```
...
**Usage:**
```bash
./venv/bin/python manage.py batch_photo_upload media_analysis/tests/fixtures/labubu_test.json
```
...
**Usage:**
```bash
./venv/bin/python manage.py batch_photo_upload media_analysis/tests/fixtures/beverages.json --no-cache
```
...
./venv/bin/python manage.py batch_photo_upload media_analysis/tests/fixtures/bourbon_vs_beer.json --no-cache --delay=1
```
...
./venv/bin/python manage.py batch_photo_upload media_analysis/tests/fixtures/all_photos.json --no-cache --delay=2
```
...
**Important:** Photo filenames must exist in the `media_analysis/tests/fixtures/` directory.
