...
**Code Location**: `media_analysis/utils/room_matching.py:140-152`
...
### Constants (`media_analysis/utils/room_matching.py`)
...
from media_analysis.utils.room_matching import generate_room_embedding
...
- `media_analysis.0009`: Removed 10 caption fields from PhotoAnalysis
...
- **Models**: `media_analysis/models.py`, `chats/models.py`
- **Views**: `media_analysis/views.py:86-404`
- **Utilities**: `media_analysis/utils/room_matching.py`
- **Management**: `media_analysis/management/commands/generate_room_embeddings.py`
- **Serializers**: `media_analysis/serializers.py`
- **Tests**: `media_analysis/tests/fixtures/` (test images)
