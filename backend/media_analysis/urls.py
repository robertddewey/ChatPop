...
from .views import PhotoAnalysisViewSet, MusicAnalysisViewSet, LocationAnalysisViewSet, ActivityPollingView
...
router.register(r'activity', ActivityPollingView, basename='activity-polling')
