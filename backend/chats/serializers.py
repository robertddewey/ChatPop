...
class NearbyDiscoverableChatSerializer(serializers.ModelSerializer):
    ...
    messages_24h = serializers.IntegerField(read_only=True)
    messages_10min = serializers.IntegerField(read_only=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            'access_mode', 'host_username', 'messages_24h', 'messages_10min', 'distance_miles'
        ]
...
class MessageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'gift_recipient', 'is_gift_acknowledged', 'is_highlight', 'highlighted_at'
        ]
        read_only_fields = [
