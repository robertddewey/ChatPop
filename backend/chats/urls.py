...
urlpatterns = [
    ...
    path('discover/<str:code>/messages/<uuid:message_id>/highlight/', MessageHighlightView.as_view(), name='message-highlight-ai'),
    path('discover/<str:code>/messages/<uuid:message_id>/broadcast-sticky/', BroadcastStickyView.as_view(), name='broadcast-sticky-ai'),
    ...
    path('<str:username>/<str:code>/messages/<uuid:message_id>/highlight/', MessageHighlightView.as_view(), name='message-highlight'),
    path('<str:username>/<str:code>/messages/<uuid:message_id>/broadcast-sticky/', BroadcastStickyView.as_view(), name='broadcast-sticky'),
